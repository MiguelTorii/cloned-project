...
const LoadImg = ({
  ...
  return <HideUntilLoaded animationIn="bounceIn" imageToLoad={url} Spinner={loading}>
      {fallbackComponent === null ? <img onError={onError} alt={alt || 'alt'} src={url} style={style} className={className} /> : fallbackComponent}
    </HideUntilLoaded>;
};
