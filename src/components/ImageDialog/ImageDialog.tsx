...
const ImageDialog = ({
  ...
  return <Dialog fullScreen className={classes.modalContainer} contentClassName={classes.modalContent} open={open} onCancel={onClose} showHeader={false} TransitionComponent={SlideUp}>
      <Box display="flex" justifyContent="center" alignItems="center" className={classes.imageContainer} onClick={handleClickBox}>
