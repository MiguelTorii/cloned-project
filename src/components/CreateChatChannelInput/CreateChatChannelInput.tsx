...
const CreateChatChannelInput = ({
  ...
  return <ValidatorForm className={classes.validatorForm} onSubmit={handleSubmit}>
      <div className={classes.form}>
        {isFloatChat ? <div className={classes.inputContainer}>
            <SelectClassmates isFloatChat values={users} relative inputValue={inputValue} placeholder="Type a name or multiple names" error={error} errorText="You must select at least 1 classmate" cacheUniq={from} autoFocus isMulti isDisabled={isLoading} onChange={handleAutoComplete} onLoadOptions={handleLoadOptions} />
          </div> : <>
            <div className={classes.inputContainer}>
              <AutoComplete values={users} relative inputValue={inputValue} placeholder="Search for classmates" error={error} errorText="You must select at least 1 classmate" cacheUniq={from} autoFocus isMulti isDisabled={isLoading} onChange={handleAutoComplete} onLoadOptions={handleLoadOptions} />
            </div>
            <IconButton className={classes.button} onClick={handleSubmit} variant="contained" disabled={isLoading} color="primary">
