  ...
  render() {
    ...
    return <div className={classes.root}>
        <div className={classes.videoWrapper}>
          {isVideo ? <div className={classes.video} ref={this.videoinput} /> : <div className={classes.avatar}>
        ...
        <div className={classes.content}>
          <div className={classes.media}>
            {isVideo ? <VideocamIcon className={classes.icon} /> : <VideocamOffIcon className={classes.icon} />}
