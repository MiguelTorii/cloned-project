    ...
    return (
      <div className={classes.root}>
        <Paper className={classes.paper} elevation={1}>
          ...
          <Popper
            open={openPencil}
            anchorEl={this.pencilAnchorEl as any}
            placement="left"
            transition
            disablePortal
          >
          ...
          <Popper
            open={openColor}
            anchorEl={this.colorAnchorEl as any}
            placement="left"
            transition
            disablePortal
          >
          ...
          <Popper
            open={openErase}
            anchorEl={this.eraseAnchorEl as any}
            placement="left"
            transition
            disablePortal
          >
...
export default withStyles(styles as any)(WhiteboardControls);
