            ...
            <div className={classes.content}>
              ...
              <Paper className={classes.calendarPaper} elevation={1}>
                <div className={classes.calendar}>
                  <BigCalendar localizer={localizer} events={events} views={{
                  month: true // agenda: AgendaDate

                }} startAccessor="start" endAccessor="end" components={components} onSelectEvent={this.handleSelectEvent} />
                </div>
              </Paper>
            </div>
          </Paper>
        </main>
        <Dialog open={id !== -1 && title !== '' && due !== '' && label !== -2 && status !== -1} okTitle="OK" onCancel={this.handleClose} onOk={this.handleClose} showActions title="View Event">
          <List component="div" disablePadding>
            <ListItem button dense key={id} onClick={this.handleUpdate({
            id,
            status: status === 2 ? 1 : 2
          })}>
              <ListItemIcon>
              ...
              <ListItemText inset primary={title} secondary={due} secondaryTypographyProps={{
              color: 'textPrimary'
            }} />
