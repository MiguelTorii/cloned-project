...
const AnonymousButton = ({
  ...
  const button = useMemo(() => active ? <img alt="anonymous button" src={anon} /> : <img alt="anonymous button" src={anoff} />, [active]);
  return <Grid className={classes.button} onClick={toggleActive}>
      {button}
    </Grid>;
};
