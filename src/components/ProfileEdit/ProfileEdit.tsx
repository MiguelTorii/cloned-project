...
class ProfileEdit extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    return <Dialog className={classes.dialog} okTitle="Save" onCancel={onClose} onOk={this.handleSubmit} open={open} showActions showCancel title="About Me">
        <div className={classes.form}>
          <FormControl fullWidth margin="normal">
            <InputLabel htmlFor="studyGroupPreference" classes={{
            shrink: classes.shrink
          }}>
              Do you prefer to study in groups or individually?
            </InputLabel>
            <Select value={studyGroupPreference} inputProps={{
          ...
          <FormControl fullWidth margin="normal">
            <InputLabel htmlFor="studyLocationPreference" classes={{
            shrink: classes.shrink
          }}>
              Do you prefer to study in person or virtually?
            </InputLabel>
            <Select value={studyLocationPreference} onChange={this.handleChange('studyLocationPreference')} inputProps={{
          ...
          <FormControl fullWidth margin="normal">
            <InputLabel htmlFor="subjectsPreference" classes={{
            shrink: classes.shrink
          }}>
              Do you enjoy getting involved in helping classmates?
            </InputLabel>
            <Select value={subjectsPreference} onChange={this.handleChange('subjectsPreference')} inputProps={{
          ...
          <TextField margin="normal" fullWidth label="What is your major/concentration of study?" placeholder="Answer" InputLabelProps={{
          shrink: true,
          classes: {
            shrink: classes.shrink
          }
        }} onChange={this.handleChange('major')} name="major" value={major} />
          <TextField margin="normal" fullWidth label="List any clubs or organizations that you're a part of" placeholder="Answer" InputLabelProps={{
          shrink: true,
          classes: {
            shrink: classes.shrink
          }
        }} onChange={this.handleChange('clubsOrOrganizations')} name="clubsOrOrganizations" value={clubsOrOrganizations} />
        </div>
      </Dialog>;
  }
