...
const CalendarControls = ({
  ...
  return <Grid className={classes.container} container justifyContent="space-between">
      <Grid item xs={4}>
        ...
        <Button aria-label="today" onClick={today} className={classes.today} color="primary" disabled={todayDisabled}>
          Today
        </Button>
      </Grid>
      {
