...
const DateInput = ({
  ...
  return <Grid container spacing={2} style={style}>
      <Grid item xs={6}>
        <TextField size="small" fullWidth variant="outlined" label="Due Date" className={cx(classes.datePicker, fixed && classes.fixed)} InputProps={{
      ...
      <Grid item xs={6}>
        <TextField size="small" fullWidth variant="outlined" label="Time" className={cx(classes.datePicker, fixed && classes.fixed)} InputProps={{
        inputComponent: DateInputComponent,
        inputProps: {
          component: DatePicker,
          selected,
