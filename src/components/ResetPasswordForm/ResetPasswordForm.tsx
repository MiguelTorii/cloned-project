    ...
    return <main className={classes.main}>
        <Paper className={classes.paper}>
          ...
          <ValidatorForm instantValidate={false} onSubmit={onSubmit} className={classes.form}>
            <TextValidator label="Password" margin="normal" onChange={onChange('password')} name="password" autoComplete="current-password" fullWidth type="password" value={password} disabled={loading} validators={['required']} errorMessages={['password is required']} />
