...
const LeaderBoardTabs = ({
  ...
  return <Dialog className={classes.dialog} onCancel={handleCloseDialog} open={openDialog} title={dialogTitle}>
      ...
      padding: 20
        ...
        <div className={classes.mvpActions}>
          {mvpActions.map(action => <div key={action.title} className={classes.mvpAction}>
