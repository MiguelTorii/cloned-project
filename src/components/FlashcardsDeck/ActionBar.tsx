...
const ActionBar = ({
  ...
  return <Box display="flex" justifyContent="space-between" className={classes.actionBar}>
      <ActionItem icon={IconEye} activeIcon={IconEyeGradient} text={search.includes('past') ? 'View' : 'View/Edit'} onClick={onViewEdit} />
      <ActionItem icon={IconBookmark} activeIcon={IconBookmarkGradient} text="Bookmark" active={bookmarked} onClick={onBookmark} />
      <PopupState variant="popover">
        {popupState => <>
            ...
            onShareLink();
              ...
              {isOwn && <MenuItem className={classes.reportText} onClick={() => {
            popupState.close();
            onDelete();
          }}>
