  ...
  return <Dialog className={classes.dialog} onCancel={handleClose} open={open} showActions={false} contentClassName={classes.contentClassName} title={<div className={classes.title}>
      ...
      {!reported && <>
          <FormControl fullWidth variant="outlined" className={classes.selectForm}>
            ...
            <Select labelId="reporter-select-label" className={cx(classes.select, classes.nameSelect)} value={[ownerId]} fullWidth disabled MenuProps={{
          anchorOrigin: {
            vertical: 'bottom',
            horizontal: 'left'
          },
          ...
          getContentAnchorEl: null
                  ...
                  {selected.map(value => <Chip className={classes.chip} key={value} label={ownerName} />)}
                </div>} />
