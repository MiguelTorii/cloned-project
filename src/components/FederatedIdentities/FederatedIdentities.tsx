    ...
    return <main className={classes.main}>
        <div className={classes.paper}>
          ...
          <div className={cx(classes.options, classes.show)}>
            <AutoComplete values={school} inputValue="" label="" placeholder="Search your school/college" error={error} errorText="You must select an option" onChange={onChange} onLoadOptions={onLoad} />
            <Button variant="contained" color="primary" className={classes.button} disabled={!school} onClick={onSubmit}>
              Log In
            </Button>
          </div>
        </div>
