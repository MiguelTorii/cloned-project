...
export const formats = ['bold', 'italic', 'underline', 'align', 'strike', 'list', 'bullet', 'indent', 'image', 'formula'];
export const QuillToolbar = ({
  ...
  return <div id={id} className={classes.toolbar}>
      <span className="ql-formats">
        ...
        <Tooltip title={QUILL_TOOLBAR_SHORT_KEYS.IMAGE} aria-label="image" arrow placement="top" classes={{
        tooltip: classes.tooltip,
        popper: classes.popper
      }}>
