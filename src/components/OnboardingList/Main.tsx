...
import type { OnboardingList as OnboardingListType, OnboardingListItem as OnboardingListItemType } from "types/models";
...
const OnboardingList = ({
  ...
  const OnboardingListItem = ({
    ...
    item: OnboardingListItemType;
  }) => <Link completed={item.completed} href={ID_TO_URL[item.id]} component={ItemLink}>
      <div className={classes.listItem}>
        <div className={classes.listItemCheckBox}>
          {item.completed ? <img src={checkmarkSvg} alt="checkmark" /> : <img src={checkmarkEmptySvg} alt="checkmark" />}
        </div>
  ...
  return <div className={classes.container}>
      ...
      <div className={classes.list}>
        {onboardingList.checklist.map(item => <OnboardingListItem key={item.id} item={item} />)}
      </div>
