...
class Header extends React.PureComponent<Props, State> {
  ...
  render() {
    const {
      ...
      onChange,
      onEditProfile,
      onSeePointsHistoryDetails // onStudyCircle
    ...
    return <div className={classes.container}>
        <Paper className={classes.root} elevation={0}>
          ...
          <div className={classes.actionContainer}>
            {isMyProfile ? <IconButton classes={{
          ...
          <div className={classes.avatarContainer}>
            <div className={classes.avatar}>
              <OnlineBadge isOnline={isOnline} bgColorPath="circleIn.palette.feedBackground" fromChat={false}>
                <Avatar alt={initials} src={userProfileUrl} className={classes.bigAvatar} classes={{
                img: classes.img
              }}>
                  {initials}
                </Avatar>
        ...
        <Tabs value={tab} textColor="primary" onChange={onChange} variant="fullWidth" classes={{
        root: classes.tabs
      }}>
          {
          /* <Tab label="Profile" /> */
