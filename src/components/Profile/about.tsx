        ...
        <Paper className={classes.root} elevation={0}>
          <div className={classes.content}>
            <div className={classes.header}>
              ...
              {isMyProfile && <Button variant="outlined" color="primary" className={classes.button} onClick={onOpenEdit}>
                  Edit About Me
                </Button>}
            </div>
            {about.length === 0 && isMyProfile ? <Button variant="contained" color="primary" className={classes.button} onClick={onOpenEdit}>
                Help your classmates learn more about you
              </Button> : about.map(item => <div key={item.id}>
