...
const ChatMessage = ({
  ...
  const renderItem = ({
    ...
    return <AnyFileUpload message={message} files={files} onImageClick={onImageClick} onImageLoaded={onImageLoaded} renderHtmlWithImage={renderHtmlWithImage} smallChat />;
  };

  return <>
      {messageList.map(message => <ListItem key={message.sid} alignItems="flex-start" className={classes.root}>
