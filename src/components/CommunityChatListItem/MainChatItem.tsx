...
const MainChatItem = ({
  ...
  return <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} className={classes.container}>
      <ButtonBase className={cx(classes.root, {
      [classes.dark]: dark,
      [classes.selected]: selected
        ...
        <div className={classes.grow}>
          ...
          {members?.length > 2 && <Typography className={classes.groupMemberCount} variant="subtitle1" noWrap>
      ...
      <Menu anchorEl={anchorEl} keepMounted open={Boolean(anchorEl)} anchorOrigin={{
      vertical: 'bottom',
      horizontal: 'left'
    }} transformOrigin={{
      vertical: 'top',
      ...
      {targetChannel && <EditGroupDetailsDialog title="Group Details" channel={targetChannel} localChannel={local[targetChannel.sid]} open={editGroupDetailsOpen} updateGroupName={handleUpdateGroupName} onClose={handleEditGroupDetailsClose} />}
      <Dialog ariaDescribedBy="remove-dialog-description" className={classes.dialog} okTitle="Leave" onCancel={handleRemoveClose} onOk={handleRemoveSubmit} open={removeChat} showActions showCancel title="Leave Group">
