...
class SimpleErrorDialog extends React.PureComponent<ProvidedProps & Props, State> {
  ...
  render() {
    ...
    return <Dialog ariaDescribedBy="alert-dialog-description" className={classes.dialog} onCancel={handleClose} open={open} title={title}>
        <Typography color="textPrimary" id="alert-dialog-description">
          {body}
        </Typography>
        <div className={classes.buttons}>
          {showSignup && <TransparentButton className={classes.button} onClick={this.handleSignUp}>
              Sign up
            </TransparentButton>}
