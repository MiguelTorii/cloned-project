...
export const campaignActions = {
  ...
  GET_HUD_CAMPAIGN: 'GET_HUD_CAMPAIGN',
  GET_LEADERBOARD_AND_SUPPORTCENTER_VISIBILITY_CAMPAIGN: 'GET_LB_AND_SC_VISIBILITY_CAMPAIGN'
};
...
export const chatActions = {
  ...
  SET_CURRENT_COMMUNITY_CHANNEL_ID: 'SET_CURRENT_COMMUNITY_CHANNEL_ID',
  SET_CURRENT_COMMUNITY_ID: 'SET_CURRENT_COMMUNITY_ID',
  SET_CURRENT_COMMUNITY_BY_ID: 'SET_CURRENT_COMMUNITY_BY_ID',
  SET_MAIN_MESSAGE: 'SET_MAIN_MESSAGE',
  CLOSE_NEW_CHANNEL: 'CLOSE_NEW_CHANNEL',
  NEW_CHAT_MESSAGE: 'NEW_CHAT_MESSAGE',
  CHAT_START_LOADING: 'CHAT_START_LOADING',
  CHAT_END_LOADING: 'CHAT_END_LOADING',
  MUTE_CHANNEL: 'MUTE_CHANNEL',
  CREATE_NEW_CHANNEL: 'CREATE_NEW_CHANNEL',
  SET_CURRENT_CHANNEL_ID: 'SET_CURRENT_CHANNEL_ID',
  OPEN_CREATE_CHAT_GROUP_CHANNEL_REQUEST: 'OPEN_CREATE_CHAT_GROUP_CHANNEL_REQUEST',
  ...
  MAIN_MESSAGE_LOADING: 'MAIN_MESSAGE_LOADING'
};
