...
export const WORKFLOW_AREA = 'WORKFLOW_AREA';
...
export const mainSubAreasInOrder: Record<string, string[]> = {
  ...
  [STUDY_TOOLS_MAIN_AREA]: [FLASHCARDS_AREA, NOTES_AREA, WORKFLOW_AREA, STUDY_TIPS_AREA],
  [ACHIEVEMENTS_MAIN_AREA]: [LEADERBOARD_AREA, GOALS_AREA],
  [MORE_MAIN_AREA]: [
    SUPPORT_AREA,
    GIVE_FEEDBACK_AREA,
    GET_THE_MOBILE_APP_AREA,
    UNBLOCK_CLASSMATES_AREA,
    STUDENT_HELP_AREA
  ]
};
