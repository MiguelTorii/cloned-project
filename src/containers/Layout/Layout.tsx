...
import ReferralStatus from "containers/Referrals/Status";
...
const Layout = ({
  ...
  return <>
      <ErrorBoundary>
        <MainLayout fullName={name} email={email} viewedOnboarding={viewedOnboarding} bannerHeight={bannerHeight} setBannerHeight={setBannerHeight} expertMode={expertMode} announcementData={announcementData} isExpert={isExpert} toggleExpertMode={toggleExpertMode} helpLink={helpLink} unreadMessages={unreadMessages} userId={userId} runningTour={runningTour} landingPageCampaign={campaign.landingPageCampaign} newNotesScreen={campaign.newNotesScreen} newClassExperience={campaign.newClassExperience} initials={initials} pushTo={push} userProfileUrl={profileImage} unreadCount={unreadCount} pathname={pathname} updateFeed={updateFeed} userClasses={userClasses} setOneTouchSend={setOneTouchSend} handleNotificationOpen={handleNotificationOpen} handleSignOut={signOut} onManageClasses={handleOpenManageClasses} onManageBlockedUsers={handleOpenBlockedUsers} // onOpenAnnouncements={handleOpenAnnouncements}
      ...
      <ErrorBoundary>
        <Notifications anchorEl={anchorEl} onClose={handleNotificationClose} onUpdateUnreadCount={handleUpdateUnreadCount} onClick={handleNotificationClick} />
      </ErrorBoundary>
      <ErrorBoundary>
        <AddRemoveClasses open={manageClasses} onClose={handleCloseManageClasses} onOpenRequestClass={handleOpenRequestClass} />
      </ErrorBoundary>
      <ErrorBoundary>
        <BlockedUsersManager open={manageBlockedUsers} onClose={handleCloseManageBlockedUsers} />
      </ErrorBoundary>
      <ErrorBoundary>
        <Dialog className={classes.dialog} onCancel={handleCloseReferralStatus} open={referralStatus} title="Referred Classmates Status">
          <ReferralStatus />
        </Dialog>
      </ErrorBoundary>
      <ErrorBoundary>
