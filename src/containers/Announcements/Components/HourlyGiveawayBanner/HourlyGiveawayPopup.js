  ...
  return (
    <div className={classes.body}>
      ...
      <div className={classes.row}>
        ...
        <div className={classes.text}>
          Every hour, up to 25 students on your campus who share notes, create flashcards, or share
          a helpful link will win.
        </div>
      </div>
      <div className={classes.row}>
        <div className={classes.subtitle}>Can I win multiple times in a week?</div>
        <div className={classes.text}>
          Yes. you can win each day, but don't spam CircleIn. If you have good notes you've taken
          from lectures in 4 different classes, that counts as 4 posts.
          <br />
          <br />
          If you are getting ready for upcoming tests in 3 different classes, creating 3 different
          sets fo flashcards for each test counts as 3 posts.
        </div>
      </div>
      <div className={classes.row}>
      ...
      <div className={classes.row}>
        <div className={classes.subtitle}>What if my classmates haven't joined CircleIn yet?</div>
        <div className={classes.text}>
          ...
          gift card is you can win ($10-$50).
        </div>
      </div>
      <div className={classes.row}>
        <div className={classes.subtitle}>Is there anything else I can do to win?</div>
        <div className={classes.text}>
          Yes! Setup group class chats and get active in chatting with your classmates about
          problems. Earn posts by getting together using our Video Meet-Up, create reminders for
          yourself. The more active you are on CircleIn for all of your studying needs, the more it
          helps you as a student and helps you win.
        </div>
      </div>
      <div className={classes.row}>
