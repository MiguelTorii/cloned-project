...
class TwoWeekNotesContest extends React.PureComponent<Props, State> {
  ...
  render() {
    ...
    return <ErrorBoundary>
        <Dialog okTitle="Head to Reward Store" onCancel={this.handleClose} onOk={this.handleClick} open={open} showActions title="TWO-WEEK NOTES CONTEST">
...
export default connect(mapStateToProps, mapDispatchToProps)(withRoot(withSnackbar(withStyles(styles)(TwoWeekNotesContest))));