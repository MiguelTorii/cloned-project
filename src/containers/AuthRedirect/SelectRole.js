      ...
      <div className={classes.options}>
        ...
        >
          ...
          <MenuItem value="email">
            ...
            <Tooltip
              title={<Typography className={classes.tooltipText}>You may need to log onto the main application without going through your school’s LMS. Choose this option to do so.</Typography>}
              classes={{
      ...
      >
        <div className={classes.content}>
          <Typography color="textPrimary" className={classes.dialogText}>
            If you’re trying to log into the main CircleIn application to support students, you’ll want to log in using the <b>Tutor, Mentor, Supplemental Instructor, or Other</b> role. An example of people who might fall into this role include (but or not limited to):
          </Typography>
          ...
          <Typography color="textPrimary" className={classes.dialogText}>
If you’re trying to access the Insights Dashboard, select the <b>Faculty, Administrator, or Director</b> role.
          </Typography>

          <Typography color="textPrimary" className={classes.dialogCaption}>
If you need access to CircleIn but are not sure if you need access to the main application, Insights Dashboard, or both, please contact your institution or us at support@circleinapp.com for help.
          </Typography>
          <Button
