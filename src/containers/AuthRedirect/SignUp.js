...
const SignUp = ({ school, updateError, setScreen, signUp }) => {
  ...
  }, [classes.container, classes.createButton, classes.form, classes.login, classes.orButton, classes.textField, goLogin, handleSubmit, onSubmit, state.confirmEmail, state.confirmPassword, state.email, state.error, state.firstName, state.lastName, state.loading, state.password, updateSignup])
  ...
  ), [classes.container, classes.createButton, classes.textField, handleVerifyCode, onSubmitVerification, state.code, state.loading, updateSignup])
