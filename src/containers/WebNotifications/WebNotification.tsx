...
type Props = {
  ...
  updateTitle: (...args: Array<any>) => any;
};
type State = {};
...
class WebNotification extends React.Component<Props, State> {
  ...
  playSound = () => {// document.getElementById('sound').play();
  };
  ...
  render() {
    ...
    return <Fragment>
        <Notification ignore={ignore && title !== ''} notSupported={this.handleNotSupported} onPermissionGranted={this.handlePermissionGranted} onPermissionDenied={this.handlePermissionDenied} onShow={this.handleNotificationOnShow} onClick={this.handleNotificationOnClick} onClose={this.handleNotificationOnClose} onError={this.handleNotificationOnError} timeout={5000} title={title} options={options} />
        {
