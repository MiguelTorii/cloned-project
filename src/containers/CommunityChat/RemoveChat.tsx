...
const RemoveChat = ({
  ...
  return <Grid container justifyContent="center" classes={{
    root: classes.removeChannel
  }}>
      <Button onClick={handleRemoveOpen} variant="outlined" startIcon={<img src={leaveGroup} alt="Leave group" />} classes={{
