...
const RightMenu = ({
  ...
  return <Box display="flex" flexDirection="column" className={classes.container}>
      <Grid container alignItems="flex-start" justifyContent="flex-start" classes={{
      root: classes.header
    }} item>
        {
      ...
      root: classes.usersContainer
        ...
        <List dense className={classes.listRoot}>
          ...
          return <HoverPopup userId={m.userId} key={m.userId} profileSource={PROFILE_PAGE_SOURCE.CHAT}>
                <ListItem component={MyLink} disableGutters link={buildPath(`/profile/${m.userId}`, {
              ...
              secondaryAction: classes.secondaryAction
                  ...
                  <Box display="flex" justifyContent="space-between" alignItems="center" className={classes.memberName}>
                    {fullName}
