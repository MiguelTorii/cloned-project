...
const ChatTextField = ({
  ...
  return <Paper className={classes.root} elevation={1}>
      <div className={classes.iconButton}>
        <IconButton className={classes.imgIcon} onClick={handleOpenInputFile} aria-label="Insert Photo">
          <AddFile />
        </IconButton>
      </div>
      <form autoComplete="off" className={classes.form} onSubmit={handleSubmit}>
        <div className={classes.inputContainer}>
          ...
          minHeight: 44
            ...
            {image && <ButtonBase className={classes.imgContainer} onClick={handleRemoveImg} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                <img className={classes.img} src={image} alt="test" />
                {isHover && <div className={classes.clearIcon}>
        ...
        {(message || image) && <Tooltip arrow classes={{
        tooltip: classes.tooltip
      }} placement="top" title="Press enter to send">
            <div className={classes.iconButton}>
              <IconButton color="primary" className={classes.imgIcon} type="submit" aria-label="Send">
                <SendIcon classes={{
