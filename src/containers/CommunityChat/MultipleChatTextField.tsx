        ...
        <div className={classes.formContainer}>
          <div className={classes.inputContainer}>
            ...
            minHeight: 44
              ...
              {false && image && <ButtonBase className={classes.imgContainer} onClick={handleRemoveImg} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                  <img className={classes.img} src={image} alt="test" />
                  {isHover && <div className={classes.clearIcon}>
                      <ClearIcon fontSize="small" />
                    </div>}
                </ButtonBase>}
              <InputBase value={message} onChange={handleChange} className={classes.textfield} inputComponent={Textarea} inputProps={{
              style: {
                maxHeight: 100,
                paddingTop: 5,
                width: '100%'
              }
            }} multiline rows={4} // placeholder="Type a message"
