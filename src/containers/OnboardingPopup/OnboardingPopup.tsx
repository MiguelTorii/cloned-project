...
const OnboardingPopup = ({
  ...
  return <Dialog className={classes.dialog} contentClassName={classes.dialogContent} open={open} showHeader={false} onCancel={closePopup}>
      <OnboardingStep data={onboardingSteps[step]} step={step + 1} totalSteps={onboardingSteps.length} onAction={onStepAction} onBackAction={onBackAction} onClose={closePopup} />
    </Dialog>;
};
