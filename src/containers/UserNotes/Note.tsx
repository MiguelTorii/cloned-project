...
const Note = ({
  ...
  return <div onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave} className={classes.itemContainer}>
      <ListItem button className={classes.listItem} onClick={handleEditNote}>
        <ListItemText primary={noteData.title} classes={{
        primary: classes.listPrimary
      }} />
      </ListItem>
      {hovered && <IconButton aria-label="delete" className={classes.delete} onClick={handleDeleteNote}>
