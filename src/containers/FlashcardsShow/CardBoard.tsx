...
const CardBoard = ({
  ...
  return <ReactCardFlip isFlipped={!isQuestion} key={currentData.id}>
      <div key="front">
        <CardBoardContent content={currentData.question} image={currentData.question_image_url} toolbarId={QUESTION_TOOLBAR_ID} onFlip={handleFlip} />
      </div>
      <div key="back">
        <CardBoardContent content={currentData.answer} image={currentData.answer_image_url} toolbarId={ANSWER_TOOLBAR_ID} onFlip={handleFlip} />
      </div>
    </ReactCardFlip>;
};
