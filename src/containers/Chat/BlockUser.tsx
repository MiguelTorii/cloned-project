...
const BlockUser = ({
  ...
  return <Grid container justifyContent="center">
      <Button onClick={handleOpenBlock(true)} startIcon={<img src={BlockUserIcon} alt="block user" />} variant="outlined" classes={{
      label: classes.blockLabel,
      root: classes.blockButton
    }}>
        Block {otherUser.firstname}
      </Button>
      <Dialog ariaDescribedBy="confirm-dialog-description" className={classes.dialog} okTitle="Yes, I'm sure" onCancel={handleOpenBlock(false)} onOk={onOk} open={blockUser} showActions showCancel title="Block User">
