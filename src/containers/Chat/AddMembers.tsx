...
const AddMembers = ({
  ...
  return <Grid container justifyContent="center" classes={{
    root: classes.addMembers
      ...
      <Button onClick={handleCreateChannelOpen} variant="outlined" startIcon={<img src={AddUserIcon} alt="Add user" />} classes={{
      label: classes.addLabel,
      root: classes.addButton
    }}>
        Add a classmate
      </Button>
      <CreateChatChannelDialog title="Add Members" chatType={channelType} onClose={handleCreateChannelClose} onLoadOptions={handleLoadOptions} onSubmit={onSubmit} isLoading={loading} okLabel="Add" />
    </Grid>;
};
