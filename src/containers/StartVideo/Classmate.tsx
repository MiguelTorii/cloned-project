...
const Classmate = ({
  ...
  return <ListItem className={clsx(width === 'xs' && classes.buttons)}>
      ...
      <ListSubheader component="div" disableGutters>
        {videoEnabled && <Button variant="contained" className={isInvited ? classes.invited : classes.invite} startIcon={isInvited ? <CheckCircleIcon className={classes.circleCheck} /> : <VideocamRoundedIcon />} onClick={handleClick} color="primary">
            {videoButtonText}
          </Button>}
      </ListSubheader>
    </ListItem>;
