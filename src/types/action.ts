...
export type Action = SignInUserRequest | SignInUserSuccess | SignInUserError | UpdateClasses | SignInUserClearError | CheckUserRequest | SignOutUserRequest | OpenCreateChatGroupChannelRequest;