...
const circleInTheme = {
  ...
  rightPanelCardBackground: '#1F1F1F',
  gray4: '#333333',
...
let theme = createTheme({
  ...
  circleIn: {
    palette: {
      ...
      lightBorders: circleInTheme.lightBorders,
      ...
      profileBadgeColor: circleInTheme.profileBadgeColor,
      ...
      rightPanelCardBackground: circleInTheme.rightPanelCardBackground,
