...
export const createTodo = async ({
  ...
  try {
    const token = await getToken();
    const result = await axios.post(`${API_ROUTES.TODO}`, {
      title,
      category: categoryId,
      due_date: date,
...
export const updateTodo = async ({
  ...
  try {
    const token = await getToken();
    const result = await axios.put(`${API_ROUTES.TODO}/${id}/edit`, {
      title,
      section_id: sectionId,
      category: categoryId,
      description,
...
export const updateTodosOrdering = async ({
  ...
  try {
    const token = await getToken();
    const result = await axios.put(`${API_ROUTES.TODO}/bulk_edit`, {
      ordering
    }, {
      headers: {
        Authorization: `Bearer ${token}`
...
export const archiveTodo = async ({
  ...
  try {
    const token = await getToken();
    const result = await axios.post(`${API_ROUTES.TODO}/${id}/archive`, {}, {
      headers: {
        Authorization: `Bearer ${token}`
      }
    });
